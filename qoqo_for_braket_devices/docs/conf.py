...
project = "qoqo_for_braket_devices"
...
htmlhelp_basename = "qoqofor_braketdevicesdoc"
...
latex_documents = [
    (
        master_doc,
        "qoqo_for_braket_devices.tex",
        "qoqo_for_braket_devices Documentation",
...
man_pages = [(master_doc, "qoqofor_braketdevices", "qoqo_for_braket_devices Documentation", [author], 1)]
...
texinfo_documents = [
    (
        ...
        author,
        "qoqo_for_braket_devices",
        "for_braket devices interface for the qoqo quantum toolkit.",
        "Miscellaneous",
    ),
]
