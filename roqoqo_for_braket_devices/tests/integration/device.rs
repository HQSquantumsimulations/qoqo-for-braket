...
// use roqoqo_for_braket_devices::AWSDevice::*;
...
#[test_case(AWSDevice::from(OQCLucyDevice::new()); "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()); "RigettiAspenM3Device")]
fn test_single_qubit_gate_time(device: AWSDevice) {
...
#[test_case(AWSDevice::from(OQCLucyDevice::new()); "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()); "RigettiAspenM3Device")]
fn test_set_single_qubit_gate_time(mut device: AWSDevice) {
...
#[test_case(AWSDevice::from(OQCLucyDevice::new()); "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()); "RigettiAspenM3Device")]
fn test_single_qubit_gate_names(device: AWSDevice) {
    assert_eq!(
...
#[test_case(AWSDevice::from(OQCLucyDevice::new()); "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()); "RigettiAspenM3Device")]
fn test_two_qubit_gate_time(device: AWSDevice) {
...
#[test_case(AWSDevice::from(OQCLucyDevice::new()); "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()); "RigettiAspenM3Device")]
fn test_set_two_qubit_gate_time(mut device: AWSDevice) {
    // Correct setters
...
#[test_case(AWSDevice::from(OQCLucyDevice::new()); "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()); "RigettiAspenM3Device")]
fn test_two_qubit_gate_names(device: AWSDevice) {
...
#[test_case(AWSDevice::from(IonQAria1Device::new()), 5; "IonQAria1Device")]
#[test_case(AWSDevice::from(IonQHarmonyDevice::new()), 7; "IonQHarmonyDevice")]
#[test_case(AWSDevice::from(OQCLucyDevice::new()), 7; "OQCLucyDevice")]
#[test_case(AWSDevice::from(RigettiAspenM3Device::new()), 5; "RigettiAspenM3Device")]
