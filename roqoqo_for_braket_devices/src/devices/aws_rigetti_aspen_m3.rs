...
pub struct RigettiAspenM3Device {
...
impl RigettiAspenM3Device {
    /// Creates a new RigettiAspenM3Device.
    ///
    /// # Returns
    ///
    /// An initiated RigettiAspenM3Device with single and two-qubit gates and decoherence rates set to zero.
    ///
    pub fn new() -> Self {
        let mut device = Self {
            number_qubits: 80,
...
impl Default for RigettiAspenM3Device {
    fn default() -> Self {
        Self::new()
    }
}

impl From<&RigettiAspenM3Device> for AWSDevice {
    fn from(input: &RigettiAspenM3Device) -> Self {
        Self::RigettiAspenM3Device(input.clone())
    }
}

impl From<RigettiAspenM3Device> for AWSDevice {
    fn from(input: RigettiAspenM3Device) -> Self {
        Self::RigettiAspenM3Device(input)
    }
}
...
/// Implements QoqoDevice trait for RigettiAspenM3Device.
///
/// The QoqoDevice trait defines standard functions available for roqoqo devices.
///
impl QoqoDevice for RigettiAspenM3Device {
    ...
    fn longest_chains(&self) -> Vec<Vec<usize>> {
        vec![vec![
            0, 1, 16, 17, 10, 11, 26, 27, 20, 21, 36, 37, 30, 31, 46, 47, 40, 41, 42, 43, 44, 45,
            32, 33, 34, 35, 22, 23, 24, 25, 12, 13, 14, 15, 2, 3, 4, 5, 6, 7, 104, 105, 106, 107,
            100, 101, 116, 117, 110, 111, 126, 127, 120, 121, 136, 137, 130, 131, 146, 147, 140,
            141, 142, 143, 144, 145, 132, 133, 134, 135, 122, 123, 124, 125, 112, 113, 114, 115,
            102, 103,
        ]]
    }
    ...
    fn two_qubit_edges(&self) -> Vec<(usize, usize)> {
        ...
        for factor in [0, 10, 20, 30, 40, 100, 110, 120, 130, 140] {
