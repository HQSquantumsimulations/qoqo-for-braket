...
impl OQCLucyDevice {
    /// Creates a new OQCLucyDevice.
    ///
    /// # Returns
    ///
    /// An initiated OQCLucyDevice with single and two-qubit gates and decoherence rates set to zero.
    ///
    pub fn new() -> Self {
        let mut device = Self {
            number_qubits: 8,
...
impl Default for OQCLucyDevice {
    fn default() -> Self {
        Self::new()
    }
}

impl From<&OQCLucyDevice> for AWSDevice {
    fn from(input: &OQCLucyDevice) -> Self {
        Self::OQCLucyDevice(input.clone())
    }
}

impl From<OQCLucyDevice> for AWSDevice {
    fn from(input: OQCLucyDevice) -> Self {
        Self::OQCLucyDevice(input)
    }
}
...
/// Implements QoqoDevice trait for OQCLucyDevice.
///
/// The QoqoDevice trait defines standard functions available for roqoqo devices.
///
impl QoqoDevice for OQCLucyDevice {
